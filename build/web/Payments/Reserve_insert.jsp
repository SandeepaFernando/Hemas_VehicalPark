<%-- 
    Document   : Reserve_insert
    Created on : Sep 7, 2019, 6:19:39 PM
    ...
    <body class="w3-light-grey">
        ...
        <div class="w3-main" style="margin-left:300px;margin-top:43px;">
            ...
            <div class="row">
                ...
                <div class="col-7"></div>
                <div class="col-2">
                    <a class="btn btn-primary btn-lg" href="../Payments/ViewAllReservation.jsp">View All Reservation</a>
                </div>
                <div class="col-7"></div>
            </div>
            ...
            %>
            <div class="container">
                <form class="form-horizontal" action="<%=request.getContextPath()%>/RegisterdReservationServlet" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">          
                            <input type="text" class="form-control" placeholder="Enter Type of Notification" name="vno">
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-sm-2">Driver NIC :</label>
                        <div class="col-sm-10">          
                            <input type="text" class="form-control" placeholder="Enter Type of Notification" name="nic">
                        </div>
                    </div>
