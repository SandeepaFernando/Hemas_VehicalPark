 ...
 */
public class UpdateRegisteredRequest {
    ...
    public UpdateRegisteredRequest(int user_Id, String RVehicleNo, String RNIC, Timestamp RArrivedTime, Timestamp RLeavedTime) {
    ...
    public UpdateRegisteredRequest() {
