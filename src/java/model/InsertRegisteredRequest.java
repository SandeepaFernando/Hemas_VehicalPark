 ...
 */
public class InsertRegisteredRequest {
    ...
    public InsertRegisteredRequest(int user_Id, String RVehicleNo, String RNIC, Timestamp RArrivedTime, Timestamp RLeavedTime) {
    ...
    public InsertRegisteredRequest() {
